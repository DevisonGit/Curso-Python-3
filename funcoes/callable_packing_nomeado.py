...
if __name__ == "__main__":
    print("Imposto de produto normal: ",
          calcula_imposto(1000, imposto_importado, importado=False))
    print("Imposto de produto Importado: ",
          calcula_imposto(1000, imposto_importado, importado=True))
    print("Imposto de produto nao explosivo: ",
          calcula_imposto(1000, imposto_explsivo, explosivo=False,
                          fator_multiplicacao=1.5))
    print("Imposto de produto explosivo: ",
          calcula_imposto(1000, imposto_explsivo, explosivo=True,
                          fator_multiplicacao=1.5))
